--- taken from https://github.com/fishtown-analytics/dbt-utils/blob/master/macros/schema_tests/equality.sql,
--- just added the environment switch...
...
--- run test if and only if "ci" has passed
{%- if target.name == 'ci' -%}
